...
<body class="bg-slate-100 text-slate-800 antialiased min-h-screen flex">
    ...
    <aside class="w-64 bg-white border-r border-slate-200 min-h-screen flex flex-col shadow-sm flex-shrink-0">
        ...
        <nav class="flex-1 px-4 py-6 space-y-1">
            ...
            <a href="{{ route('inventory.stats') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium {{ request()->routeIs('inventory.stats') ? 'bg-violet-50 text-violet-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }} transition-colors">
